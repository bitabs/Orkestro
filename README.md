...
An application that is designed to integrate Google Map and [Randomuser](https://randomuser.me/) api. It will apply 
Euclidean distance on a set of data and will select the K closest Drivers to a selected Order, and will add markers in 
the google map.
